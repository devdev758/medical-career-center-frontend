// Resume guide content for RN - separated to avoid template literal issues with markdown code blocks

export const RN_RESUME_GUIDE_CONTENT = `
...
1. **Active RN License**: Current, unencumbered license in the required state
2. **Relevant Experience**: Clinical setting match (ICU for ICU positions, etc.)
3. **Required Certifications**: BLS at minimum; specialty certs for advanced roles
4. **Education Level**: ADN vs BSN (many facilities now require or prefer BSN)
5. **Quantifiable Achievements**: Metrics that demonstrate impact
6. **Keywords**: Skills and qualifications matching the job description
...
2. **Searches** for keywords matching the job description
3. **Ranks** candidates based on keyword matches and qualifications
4. **Filters** out resumes that don't meet minimum criteria
...
**Best Format**: PDF (preserves formatting across devices)
**Exception**: If job posting specifically requests Word (.docx)
...
- ❌ cutienurse2024@email.com
- ❌ partygirl87@email.com
- ✅ sarah.johnson.rn@email.com
- ✅ sarah.m.johnson@gmail.com
...
**Font Size**: 10-12pt (11pt ideal for body text)
**Font**: Arial, Calibri, Georgia, Times New Roman
**Spacing**: 1.0-1.15 line spacing
**Bolding**: Use for section headers and job titles
**Color**: Black text on white background (conservative for healthcare)
...
**1. See Real Examples**: Check out our [resume examples](/registered-nurse/resume/examples) to see how other nurses structured their resumes

**2. Download Templates**: Get started quickly with our [free ATS-friendly templates](/registered-nurse/resume/template)

**3. Get Specialty Guidance**:
- [New Graduate Resume Guide](/registered-nurse/resume/new-grad) - Tailored for recent grads
- [ICU Nurse Resume Guide](/registered-nurse/resume/icu) - Critical care specific tips

**4. Don't Forget Your Cover Letter**: Pair your resume with a strong [nursing cover letter](/registered-nurse/resume/cover-letter)

**5. Build with AI**: Skip the manual work and use our [AI Resume Builder](/resume-builder) to create an ATS-optimized resume in minutes
