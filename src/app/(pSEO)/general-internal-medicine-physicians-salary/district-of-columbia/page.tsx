...
export const metadata = {
    title: "General Internal Medicine Physicians Salary in District of Columbia (2025 Guide)",
    description: "How much does a General Internal Medicine Physicians make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "general-internal-medicine-physicians",
    ...
    const careerTitle = "General Internal Medicine Physicians";
    ...
    const careerDescription = getCareerDescription("general-internal-medicine-physicians");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/general-internal-medicine-physicians-jobs/district-of-columbia">
