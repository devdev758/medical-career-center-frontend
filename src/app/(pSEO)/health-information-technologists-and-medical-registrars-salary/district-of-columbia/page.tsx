...
export const metadata = {
    title: "Health Information Technologists and Medical Registrars Salary in District of Columbia (2025 Guide)",
    description: "How much does a Health Information Technologists and Medical Registrars make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "health-information-technologists-and-medical-registrars",
            location: { slug: "district-of-columbia" },
            year: 2024
        },
    ...
    const careerTitle = "Health Information Technologists and Medical Registrars";
    const locationName = "District of Columbia";
    ...
    const careerDescription = getCareerDescription("health-information-technologists-and-medical-registrars");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/health-information-technologists-and-medical-registrars-jobs/district-of-columbia">
