...
export const metadata = {
    title: "Health Information Technologists and Medical Registrars Salary in Arkansas (2025 Guide)",
    description: "How much does a Health Information Technologists and Medical Registrars make in Arkansas? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/health-information-technologists-and-medical-registrars-jobs/arkansas">
