...
export const metadata = {
    title: "Nuclear Medicine Technologists Salary in District of Columbia (2025 Guide)",
    description: "How much does a Nuclear Medicine Technologists make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "nuclear-medicine-technologists",
    ...
    const careerTitle = "Nuclear Medicine Technologists";
    ...
    const careerDescription = getCareerDescription("nuclear-medicine-technologists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/nuclear-medicine-technologists-jobs/district-of-columbia">
