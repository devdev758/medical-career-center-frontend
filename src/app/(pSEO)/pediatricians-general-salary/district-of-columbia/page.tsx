...
export const metadata = {
    title: "Pediatricians, General Salary in District of Columbia (2025 Guide)",
    description: "How much does a Pediatricians, General make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "pediatricians-general",
    ...
    const careerTitle = "Pediatricians, General";
    ...
    const careerDescription = getCareerDescription("pediatricians-general");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/pediatricians-general-jobs/district-of-columbia">
