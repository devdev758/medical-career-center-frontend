...
export const metadata = {
    title: "Oral and Maxillofacial Surgeons Salary in North Carolina (2025 Guide)",
    description: "How much does a Oral and Maxillofacial Surgeons make in North Carolina? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "oral-and-maxillofacial-surgeons",
    ...
    const careerTitle = "Oral and Maxillofacial Surgeons";
    ...
    const careerDescription = getCareerDescription("oral-and-maxillofacial-surgeons");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/oral-and-maxillofacial-surgeons-jobs/north-carolina">
