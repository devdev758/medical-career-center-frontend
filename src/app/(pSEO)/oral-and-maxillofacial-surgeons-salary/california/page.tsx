...
export const metadata = {
    title: "Oral and Maxillofacial Surgeons Salary in California (2025 Guide)",
    description: "How much does a Oral and Maxillofacial Surgeons make in California? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/oral-and-maxillofacial-surgeons-jobs/california">
