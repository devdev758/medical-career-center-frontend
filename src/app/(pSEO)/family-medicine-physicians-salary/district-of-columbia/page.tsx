...
export const metadata = {
    title: "Family Medicine Physicians Salary in District of Columbia (2025 Guide)",
    description: "How much does a Family Medicine Physicians make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "family-medicine-physicians",
    ...
    const careerTitle = "Family Medicine Physicians";
    ...
    const careerDescription = getCareerDescription("family-medicine-physicians");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/family-medicine-physicians-jobs/district-of-columbia">
