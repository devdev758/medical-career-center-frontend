...
export const metadata = {
    title: "Ophthalmologists, Except Pediatric Salary in District of Columbia (2025 Guide)",
    description: "How much does a Ophthalmologists, Except Pediatric make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "ophthalmologists-except-pediatric",
    ...
    const careerTitle = "Ophthalmologists, Except Pediatric";
    ...
    const careerDescription = getCareerDescription("ophthalmologists-except-pediatric");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/ophthalmologists-except-pediatric-jobs/district-of-columbia">
