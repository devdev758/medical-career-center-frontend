...
export const metadata = {
    title: "Recreational Therapists Salary in Indiana (2025 Guide)",
    description: "How much does a Recreational Therapists make in Indiana? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/recreational-therapists-jobs/indiana">
