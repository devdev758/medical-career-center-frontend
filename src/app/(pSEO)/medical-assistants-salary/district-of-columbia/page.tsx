...
export const metadata = {
    title: "Medical Assistants Salary in District of Columbia (2025 Guide)",
    description: "How much does a Medical Assistants make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "medical-assistants",
    ...
    const careerTitle = "Medical Assistants";
    ...
    const careerDescription = getCareerDescription("medical-assistants");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/medical-assistants-jobs/district-of-columbia">
