...
export const metadata = {
    title: "Prosthodontists Salary in Virginia (2025 Guide)",
    description: "How much does a Prosthodontists make in Virginia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "prosthodontists",
    ...
    const careerTitle = "Prosthodontists";
    ...
    const careerDescription = getCareerDescription("prosthodontists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/prosthodontists-jobs/virginia">
