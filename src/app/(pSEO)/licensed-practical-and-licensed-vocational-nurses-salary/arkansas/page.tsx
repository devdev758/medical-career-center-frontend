...
export const metadata = {
    title: "Licensed Practical and Licensed Vocational Nurses Salary in Arkansas (2025 Guide)",
    description: "How much does a Licensed Practical and Licensed Vocational Nurses make in Arkansas? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/licensed-practical-and-licensed-vocational-nurses-jobs/arkansas">
