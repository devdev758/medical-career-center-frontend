...
export const metadata = {
    title: "Genetic Counselors Salary in District of Columbia (2025 Guide)",
    description: "How much does a Genetic Counselors make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "genetic-counselors",
    ...
    const careerTitle = "Genetic Counselors";
    ...
    const careerDescription = getCareerDescription("genetic-counselors");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/genetic-counselors-jobs/district-of-columbia">
