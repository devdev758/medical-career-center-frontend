...
export const metadata = {
    title: "Healthcare Diagnosing or Treating Practitioners Salary in New York (2025 Guide)",
    description: "How much does a Healthcare Diagnosing or Treating Practitioners make in New York? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/healthcare-diagnosing-or-treating-practitioners-jobs/new-york">
