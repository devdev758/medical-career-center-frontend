...
export const metadata = {
    title: "Occupational Therapy Aides Salary in Idaho (2025 Guide)",
    description: "How much does a Occupational Therapy Aides make in Idaho? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/occupational-therapy-aides-jobs/idaho">
