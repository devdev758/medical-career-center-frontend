...
export const metadata = {
    title: "Orthopedic Surgeons, Except Pediatric Salary in North Carolina (2025 Guide)",
    description: "How much does a Orthopedic Surgeons, Except Pediatric make in North Carolina? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "orthopedic-surgeons-except-pediatric",
    ...
    const careerTitle = "Orthopedic Surgeons, Except Pediatric";
    ...
    const careerDescription = getCareerDescription("orthopedic-surgeons-except-pediatric");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/orthopedic-surgeons-except-pediatric-jobs/north-carolina">
