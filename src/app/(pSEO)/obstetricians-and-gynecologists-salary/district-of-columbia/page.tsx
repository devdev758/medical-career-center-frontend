...
export const metadata = {
    title: "Obstetricians and Gynecologists Salary in District of Columbia (2025 Guide)",
    description: "How much does a Obstetricians and Gynecologists make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "obstetricians-and-gynecologists",
    ...
    const careerTitle = "Obstetricians and Gynecologists";
    ...
    const careerDescription = getCareerDescription("obstetricians-and-gynecologists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/obstetricians-and-gynecologists-jobs/district-of-columbia">
