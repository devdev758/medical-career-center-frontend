...
export const metadata = {
    title: "Hearing Aid Specialists Salary in North Carolina (2025 Guide)",
    description: "How much does a Hearing Aid Specialists make in North Carolina? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "hearing-aid-specialists",
    ...
    const careerTitle = "Hearing Aid Specialists";
    ...
    const careerDescription = getCareerDescription("hearing-aid-specialists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/hearing-aid-specialists-jobs/north-carolina">
