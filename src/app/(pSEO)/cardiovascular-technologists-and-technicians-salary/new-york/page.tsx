...
export const metadata = {
    title: "Cardiovascular Technologists and Technicians Salary in New York (2025 Guide)",
    description: "How much does a Cardiovascular Technologists and Technicians make in New York? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/cardiovascular-technologists-and-technicians-jobs/new-york">
