...
export const metadata = {
    title: "Magnetic Resonance Imaging Technologists Salary in New York (2025 Guide)",
    description: "How much does a Magnetic Resonance Imaging Technologists make in New York? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/magnetic-resonance-imaging-technologists-jobs/new-york">
