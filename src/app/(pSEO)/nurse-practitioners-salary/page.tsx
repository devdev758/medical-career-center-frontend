...
export const metadata = {
    title: "Nurse Practitioners Salary in United States (2025 Guide)",
    description: "How much does a Nurse Practitioner make in the United States? View average salary, hourly pay, and wage distribution for 2025.",
};
...
export default async function Page() {
    ...
    const careerTitle = "Nurse Practitioner";
                        ...
                        <div className="flex flex-wrap gap-2">
                            {relatedStates.map((state) => (
                                <Button key={state.id} variant="outline" size="sm" asChild>
                                    <Link href={`/nurse-practitioners-salary/${state.slug}`}>
                                        {state.stateName}
                                    </Link>
                                </Button>
                            ))}
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/nurse-practitioners-jobs">
