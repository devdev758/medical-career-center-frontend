...
export const metadata = {
    title: "Surgical Assistants Salary in Kentucky (2025 Guide)",
    description: "How much does a Surgical Assistants make in Kentucky? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/surgical-assistants-jobs/kentucky">
