...
export const metadata = {
    title: "Veterinary Assistants and Laboratory Animal Caretakers Salary in Illinois (2025 Guide)",
    description: "How much does a Veterinary Assistants and Laboratory Animal Caretakers make in Illinois? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/veterinary-assistants-and-laboratory-animal-caretakers-jobs/illinois">
