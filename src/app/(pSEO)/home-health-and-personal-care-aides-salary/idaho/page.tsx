...
export const metadata = {
    title: "Home Health and Personal Care Aides Salary in Idaho (2025 Guide)",
    description: "How much does a Home Health and Personal Care Aides make in Idaho? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/home-health-and-personal-care-aides-jobs/idaho">
