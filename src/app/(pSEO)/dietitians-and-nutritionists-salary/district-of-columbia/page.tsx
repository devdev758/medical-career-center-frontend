...
export const metadata = {
    title: "Dietitians and Nutritionists Salary in District of Columbia (2025 Guide)",
    description: "How much does a Dietitians and Nutritionists make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "dietitians-and-nutritionists",
    ...
    const careerTitle = "Dietitians and Nutritionists";
    ...
    const careerDescription = getCareerDescription("dietitians-and-nutritionists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/dietitians-and-nutritionists-jobs/district-of-columbia">
