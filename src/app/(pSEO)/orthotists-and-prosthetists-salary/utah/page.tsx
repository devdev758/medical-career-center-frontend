...
export const metadata = {
    title: "Orthotists and Prosthetists Salary in Utah (2025 Guide)",
    description: "How much does a Orthotists and Prosthetists make in Utah? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/orthotists-and-prosthetists-jobs/utah">
