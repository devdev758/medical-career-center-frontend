...
export const metadata = {
    title: "Audiologists Salary in Maryland (2025 Guide)",
    description: "How much does a Audiologists make in Maryland? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/audiologists-jobs/maryland">
