...
export const metadata = {
    title: "Opticians, Dispensing Salary in Nebraska (2025 Guide)",
    description: "How much does a Opticians, Dispensing make in Nebraska? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/opticians-dispensing-jobs/nebraska">
