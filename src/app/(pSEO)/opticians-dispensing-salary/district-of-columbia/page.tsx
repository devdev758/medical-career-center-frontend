...
export const metadata = {
    title: "Opticians, Dispensing Salary in District of Columbia (2025 Guide)",
    description: "How much does a Opticians, Dispensing make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "opticians-dispensing",
    ...
    const careerTitle = "Opticians, Dispensing";
    ...
    const careerDescription = getCareerDescription("opticians-dispensing");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/opticians-dispensing-jobs/district-of-columbia">
