...
export const metadata = {
    title: "Speech-Language Pathologists Salary in District of Columbia (2025 Guide)",
    description: "How much does a Speech-Language Pathologists make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "speech-language-pathologists",
    ...
    const careerTitle = "Speech-Language Pathologists";
    ...
    const careerDescription = getCareerDescription("speech-language-pathologists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/speech-language-pathologists-jobs/district-of-columbia">
