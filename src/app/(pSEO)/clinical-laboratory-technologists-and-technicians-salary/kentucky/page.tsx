...
export const metadata = {
    title: "Clinical Laboratory Technologists and Technicians Salary in Kentucky (2025 Guide)",
    description: "How much does a Clinical Laboratory Technologists and Technicians make in Kentucky? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/clinical-laboratory-technologists-and-technicians-jobs/kentucky">
