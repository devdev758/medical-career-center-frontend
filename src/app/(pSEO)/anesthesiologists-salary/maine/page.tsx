...
export const metadata = {
    title: "Anesthesiologists Salary in Maine (2025 Guide)",
    description: "How much does a Anesthesiologists make in Maine? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/anesthesiologists-jobs/maine">
