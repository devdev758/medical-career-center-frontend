...
export const metadata = {
    title: "Athletic Trainers Salary in New Jersey (2025 Guide)",
    description: "How much does a Athletic Trainers make in New Jersey? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/athletic-trainers-jobs/new-jersey">
