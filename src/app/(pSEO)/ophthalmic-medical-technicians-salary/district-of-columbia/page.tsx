...
export const metadata = {
    title: "Ophthalmic Medical Technicians Salary in District of Columbia (2025 Guide)",
    description: "How much does a Ophthalmic Medical Technicians make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "ophthalmic-medical-technicians",
    ...
    const careerTitle = "Ophthalmic Medical Technicians";
    ...
    const careerDescription = getCareerDescription("ophthalmic-medical-technicians");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/ophthalmic-medical-technicians-jobs/district-of-columbia">
