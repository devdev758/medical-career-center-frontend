...
export const metadata = {
    title: "Surgical Technologists Salary in District of Columbia (2025 Guide)",
    description: "How much does a Surgical Technologists make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "surgical-technologists",
    ...
    const careerTitle = "Surgical Technologists";
    ...
    const careerDescription = getCareerDescription("surgical-technologists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/surgical-technologists-jobs/district-of-columbia">
