...
export const metadata = {
    title: "Massage Therapists Salary in District of Columbia (2025 Guide)",
    description: "How much does a Massage Therapists make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "massage-therapists",
    ...
    const careerTitle = "Massage Therapists";
    ...
    const careerDescription = getCareerDescription("massage-therapists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/massage-therapists-jobs/district-of-columbia">
