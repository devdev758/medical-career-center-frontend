...
export const metadata = {
    title: "Psychiatric Aides Salary in North Carolina (2025 Guide)",
    description: "How much does a Psychiatric Aides make in North Carolina? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "psychiatric-aides",
    ...
    const careerTitle = "Psychiatric Aides";
    ...
    const careerDescription = getCareerDescription("psychiatric-aides");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/psychiatric-aides-jobs/north-carolina">
