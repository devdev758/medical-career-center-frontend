...
export const metadata = {
    title: "Surgeons Salary in Idaho (2025 Guide)",
    description: "How much does a Surgeons make in Idaho? View average salary, hourly pay, and wage distribution for 2025.",
};
