...
export const metadata = {
    title: "Surgeons Salary in Ohio (2025 Guide)",
    description: "How much does a Surgeons make in Ohio? View average salary, hourly pay, and wage distribution for 2025.",
};
