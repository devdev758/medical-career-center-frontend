...
export const metadata = {
    title: "Surgeons Salary in Texas (2025 Guide)",
    description: "How much does a Surgeons make in Texas? View average salary, hourly pay, and wage distribution for 2025.",
};
