...
export const metadata = {
    title: "Surgeons Salary in Iowa (2025 Guide)",
    description: "How much does a Surgeons make in Iowa? View average salary, hourly pay, and wage distribution for 2025.",
};
