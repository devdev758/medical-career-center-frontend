...
export const metadata = {
    title: "Surgeons Salary in Maine (2025 Guide)",
    description: "How much does a Surgeons make in Maine? View average salary, hourly pay, and wage distribution for 2025.",
};
