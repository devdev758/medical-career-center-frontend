...
export const metadata = {
    title: "Surgeons Salary in Utah (2025 Guide)",
    description: "How much does a Surgeons make in Utah? View average salary, hourly pay, and wage distribution for 2025.",
};
