...
export const metadata = {
    title: "Orderlies Salary in Ohio (2025 Guide)",
    description: "How much does a Orderlies make in Ohio? View average salary, hourly pay, and wage distribution for 2025.",
};
