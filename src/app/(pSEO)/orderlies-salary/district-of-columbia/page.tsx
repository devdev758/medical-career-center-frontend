...
export const metadata = {
    title: "Orderlies Salary in District of Columbia (2025 Guide)",
    description: "How much does a Orderlies make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "orderlies",
    ...
    const careerDescription = getCareerDescription("orderlies");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/orderlies-jobs/district-of-columbia">
