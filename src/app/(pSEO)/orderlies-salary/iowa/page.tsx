...
export const metadata = {
    title: "Orderlies Salary in Iowa (2025 Guide)",
    description: "How much does a Orderlies make in Iowa? View average salary, hourly pay, and wage distribution for 2025.",
};
