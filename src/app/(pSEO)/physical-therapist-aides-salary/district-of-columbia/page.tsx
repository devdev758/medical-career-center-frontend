...
export const metadata = {
    title: "Physical Therapist Aides Salary in District of Columbia (2025 Guide)",
    description: "How much does a Physical Therapist Aides make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "physical-therapist-aides",
    ...
    const careerTitle = "Physical Therapist Aides";
    ...
    const careerDescription = getCareerDescription("physical-therapist-aides");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/physical-therapist-aides-jobs/district-of-columbia">
