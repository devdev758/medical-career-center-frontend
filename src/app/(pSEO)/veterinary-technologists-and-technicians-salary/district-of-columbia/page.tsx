...
export const metadata = {
    title: "Veterinary Technologists and Technicians Salary in District of Columbia (2025 Guide)",
    description: "How much does a Veterinary Technologists and Technicians make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "veterinary-technologists-and-technicians",
    ...
    const careerTitle = "Veterinary Technologists and Technicians";
    ...
    const careerDescription = getCareerDescription("veterinary-technologists-and-technicians");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/veterinary-technologists-and-technicians-jobs/district-of-columbia">
