...
export const metadata = {
    title: "Pediatric Surgeons Salary in Connecticut (2025 Guide)",
    description: "How much does a Pediatric Surgeons make in Connecticut? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "pediatric-surgeons",
    ...
    const careerTitle = "Pediatric Surgeons";
    ...
    const careerDescription = getCareerDescription("pediatric-surgeons");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/pediatric-surgeons-jobs/connecticut">
