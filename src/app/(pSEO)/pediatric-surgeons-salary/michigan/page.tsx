...
export const metadata = {
    title: "Pediatric Surgeons Salary in Michigan (2025 Guide)",
    description: "How much does a Pediatric Surgeons make in Michigan? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/pediatric-surgeons-jobs/michigan">
