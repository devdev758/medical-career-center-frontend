...
export const metadata = {
    title: "Neurologists Salary in New Hampshire (2025 Guide)",
    description: "How much does a Neurologists make in New Hampshire? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/neurologists-jobs/new-hampshire">
