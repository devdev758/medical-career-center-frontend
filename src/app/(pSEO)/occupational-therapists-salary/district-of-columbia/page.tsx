...
export const metadata = {
    title: "Occupational Therapists Salary in District of Columbia (2025 Guide)",
    description: "How much does a Occupational Therapists make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "occupational-therapists",
    ...
    const careerTitle = "Occupational Therapists";
    ...
    const careerDescription = getCareerDescription("occupational-therapists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/occupational-therapists-jobs/district-of-columbia">
