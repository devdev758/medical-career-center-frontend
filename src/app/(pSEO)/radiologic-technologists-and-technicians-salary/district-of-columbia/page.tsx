...
export const metadata = {
    title: "Radiologic Technologists and Technicians Salary in District of Columbia (2025 Guide)",
    description: "How much does a Radiologic Technologists and Technicians make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "radiologic-technologists-and-technicians",
    ...
    const careerTitle = "Radiologic Technologists and Technicians";
    ...
    const careerDescription = getCareerDescription("radiologic-technologists-and-technicians");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/radiologic-technologists-and-technicians-jobs/district-of-columbia">
