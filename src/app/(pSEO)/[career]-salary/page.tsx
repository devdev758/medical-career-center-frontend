...
async function getData(career: string) {
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return {
        ...
        description: `How much does a ${careerTitle} make? View average salary, hourly pay, and wage distribution for 2025.`,
    };
}

export default async function NationalSalaryPage({ params }: PageProps) {
    const { career } = params;
    ...
    const { salaryData, relatedLocations, careerKeyword, careerTitle } = data;
