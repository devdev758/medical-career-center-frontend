...
export const metadata = {
    title: "Dental Hygienists Salary in District of Columbia (2025 Guide)",
    description: "How much does a Dental Hygienists make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};
...
export default async function Page() {
    ...
    const careerTitle = "Dental Hygienists";
    ...
    const careerDescription = getCareerDescription("dental-hygienists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/dental-hygienists-jobs/district-of-columbia">
