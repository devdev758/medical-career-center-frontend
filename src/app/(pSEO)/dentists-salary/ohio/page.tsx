...
export const metadata = {
    title: "Dentists Salary in Ohio (2025 Guide)",
    description: "How much does a Dentists make in Ohio? View average salary, hourly pay, and wage distribution for 2025.",
};
