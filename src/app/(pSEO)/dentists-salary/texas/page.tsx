...
export const metadata = {
    title: "Dentists Salary in Texas (2025 Guide)",
    description: "How much does a Dentists make in Texas? View average salary, hourly pay, and wage distribution for 2025.",
};
