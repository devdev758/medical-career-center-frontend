...
export const metadata = {
    title: "Medical Dosimetrists Salary in South Carolina (2025 Guide)",
    description: "How much does a Medical Dosimetrists make in South Carolina? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "medical-dosimetrists",
    ...
    const careerTitle = "Medical Dosimetrists";
    ...
    const careerDescription = getCareerDescription("medical-dosimetrists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/medical-dosimetrists-jobs/south-carolina">
