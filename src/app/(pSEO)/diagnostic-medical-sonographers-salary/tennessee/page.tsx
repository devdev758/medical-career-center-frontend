...
export const metadata = {
    title: "Diagnostic Medical Sonographers Salary in Tennessee (2025 Guide)",
    description: "How much does a Diagnostic Medical Sonographers make in Tennessee? View average salary, hourly pay, and wage distribution for 2025.",
};
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/diagnostic-medical-sonographers-jobs/tennessee">
