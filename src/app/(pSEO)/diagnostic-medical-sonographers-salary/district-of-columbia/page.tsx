...
export const metadata = {
    title: "Diagnostic Medical Sonographers Salary in District of Columbia (2025 Guide)",
    description: "How much does a Diagnostic Medical Sonographers make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "diagnostic-medical-sonographers",
    ...
    const careerTitle = "Diagnostic Medical Sonographers";
    ...
    const careerDescription = getCareerDescription("diagnostic-medical-sonographers");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/diagnostic-medical-sonographers-jobs/district-of-columbia">
