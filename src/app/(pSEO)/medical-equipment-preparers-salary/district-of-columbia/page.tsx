...
export const metadata = {
    title: "Medical Equipment Preparers Salary in District of Columbia (2025 Guide)",
    description: "How much does a Medical Equipment Preparers make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "medical-equipment-preparers",
    ...
    const careerTitle = "Medical Equipment Preparers";
    ...
    const careerDescription = getCareerDescription("medical-equipment-preparers");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/medical-equipment-preparers-jobs/district-of-columbia">
