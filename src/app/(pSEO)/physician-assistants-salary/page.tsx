...
export const metadata = {
    title: "Physician Assistants Salary in United States (2025 Guide)",
    description: "How much does a Physician Assistant make in the United States? View average salary, hourly pay, and wage distribution for 2025.",
};
...
export default async function Page() {
    ...
    const careerTitle = "Physician Assistant";
                        ...
                        <div className="flex flex-wrap gap-2">
                            {relatedStates.map((state) => (
                                <Button key={state.id} variant="outline" size="sm" asChild>
                                    <Link href={`/physician-assistants-salary/${state.slug}`}>
                                        {state.stateName}
                                    </Link>
                                </Button>
                            ))}
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/physician-assistants-jobs">
