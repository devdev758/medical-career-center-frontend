...
export const metadata = {
    title: "Physician Assistants Salary in District of Columbia (2025 Guide)",
    description: "How much does a Physician Assistants make in District of Columbia? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "physician-assistants",
    ...
    const careerTitle = "Physician Assistants";
    ...
    const careerDescription = getCareerDescription("physician-assistants");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/physician-assistants-jobs/district-of-columbia">
