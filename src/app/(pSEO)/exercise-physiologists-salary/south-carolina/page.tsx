...
export const metadata = {
    title: "Exercise Physiologists Salary in South Carolina (2025 Guide)",
    description: "How much does a Exercise Physiologists make in South Carolina? View average salary, hourly pay, and wage distribution for 2025.",
};

export default async function Page() {
    const salaryData = await prisma.salaryData.findFirst({
        where: {
            careerKeyword: "exercise-physiologists",
    ...
    const careerTitle = "Exercise Physiologists";
    ...
    const careerDescription = getCareerDescription("exercise-physiologists");
            ...
            <Card className="bg-primary text-primary-foreground my-12">
                <CardContent className="p-8 text-center space-y-4">
                    ...
                    <Button size="lg" variant="secondary" asChild className="mt-4">
                        <Link href="/exercise-physiologists-jobs/south-carolina">
