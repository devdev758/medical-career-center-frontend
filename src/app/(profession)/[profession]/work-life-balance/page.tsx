    ...
    if (profession !== 'registered-nurse') {
        return (
            <main className="container mx-auto py-10 px-4 max-w-5xl">
                ...
                <div className="mb-8">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">{displayName} Work-Life Balance</h1>
                    <p className="text-xl text-muted-foreground">Work-life balance resources coming soon</p>
                </div>
                ...
                <Card className="mt-8">
                    <CardContent className="pt-8">
                        <div className="text-center space-y-6">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold mb-2">{displayName} Work-Life Balance</h2>
                                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                                    Work-life balance guides for {displayName} professionals are coming soon.
                                </p>
                            </div>
